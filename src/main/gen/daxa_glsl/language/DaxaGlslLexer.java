 ...
 * from the specification file <tt>daxa_glsl.flex</tt>
 */
class DaxaGlslLexer implements FlexLexer {
   ...
   */
  DaxaGlslLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return DaxaGlslTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return DaxaGlslTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return DaxaGlslTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return DaxaGlslTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
